...
const UpperCaseNodeComponent = memo(({ data = {}, id }: { data?: any; id: string }) => {
      ...
      <div className="space-y-3 w-72">
        ...
        <div className="space-y-2">
          ...
          <Textarea
            ...
            onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => updateData('defaultText', e.target.value)}
        ...
        <div className="flex items-center justify-between">
          ...
          <Switch
            ...
            onCheckedChange={(checked: boolean) => updateData('addPrefix', checked)}
          />
        </div>
        ...
        {data.addPrefix && (
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e: React.ChangeEvent<HTMLInputElement>) => updateData('prefix', e.target.value)}
        ...
        <div className="flex items-center justify-between">
          ...
          <Switch
            ...
            onCheckedChange={(checked: boolean) => updateData('trimSpaces', checked)}
          />
        </div>
        ...
        <div className="flex flex-wrap gap-1 pt-2 border-t">
          ...
          {!data.addPrefix && !data.trimSpaces && (
            <Badge variant={'outline' as const} className="text-xs text-gray-400">
              Simple mode
            </Badge>
          )}
        </div>
