...
const WebAPINodeComponent = ({ id, data, selected }: any) => {
  const [expanded, setExpanded] = useState(false);
  const [localData, setLocalData] = useState(data);
  
  const nodeDefinition = nodeDefinitions.web_api;
  const { inputs = [], outputs = [] }: any = nodeDefinition;
  ...
  return (
    ...
    >
      ...
      {inputs.map((input: string, index: number) => (
        ...
        >
          <div className="absolute -left-12 text-xs bg-white px-1 rounded whitespace-nowrap" style={{ transform: 'translateY(-50%)' }}>
            {input}
          </div>
        </Handle>
      ))}
      ...
      {outputs.map((output: string, index: number) => (
        ...
        >
          <div className="absolute -right-12 text-xs bg-white px-1 rounded whitespace-nowrap" style={{ transform: 'translateY(-50%)' }}>
            {output}
          </div>
        </Handle>
      ))}
      ...
      <div className="p-3">
        ...
        <div className="mb-3">
          ...
          <input
            type="text"
            value={localData.url || ''}
            onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleDataChange('url', e.target.value)}
        ...
        <div className="mb-3">
          ...
          <select
            ...
            onChange={(e: React.ChangeEvent<HTMLSelectElement>) => handleDataChange('method', e.target.value)}
            className="w-full px-2 py-1 text-sm border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-purple-500"
          >
          ...
          <>
            ...
            <div className="mb-3 p-2 bg-gray-50 rounded">
              ...
              <select
                ...
                onChange={(e: React.ChangeEvent<HTMLSelectElement>) => handleAuthChange('type', e.target.value)}
              ...
              {localData.authentication?.type === 'bearer' && (
                <input
                  ...
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleAuthChange('token', e.target.value)}
              ...
              {localData.authentication?.type === 'apikey' && (
                <>
                  <input
                    ...
                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleAuthChange('headerName', e.target.value)}
                  ...
                  <input
                    ...
                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleAuthChange('apiKey', e.target.value)}
              ...
              {localData.authentication?.type === 'basic' && (
                <>
                  <input
                    ...
                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleAuthChange('username', e.target.value)}
                  ...
                  <input
                    ...
                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleAuthChange('password', e.target.value)}
              ...
              <>
                <div className="mb-3">
                  ...
                  <select
                    ...
                    onChange={(e: React.ChangeEvent<HTMLSelectElement>) => handleDataChange('bodyType', e.target.value)}
                    className="w-full px-2 py-1 text-sm border border-gray-300 rounded"
                  >
                ...
                <div className="mb-3">
                  ...
                  <textarea
                    ...
                    onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => handleDataChange('body', e.target.value)}
            ...
            <div className="mb-3">
              ...
              <select
                ...
                onChange={(e: React.ChangeEvent<HTMLSelectElement>) => handleDataChange('responseType', e.target.value)}
                className="w-full px-2 py-1 text-sm border border-gray-300 rounded"
              >
              ...
              <div className="flex space-x-2">
                <div className="flex-1">
                  <input
                    ...
                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleDataChange('retryCount', parseInt(e.target.value) || 0)}
                    placeholder="Retries"
                    min="0"
                    max="5"
                    className="w-full px-2 py-1 text-sm border border-gray-300 rounded"
                ...
                <div className="flex-1">
                  <input
                    ...
                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleDataChange('retryDelay', parseInt(e.target.value) || 1000)}
            ...
            <div className="mb-2">
              ...
              <input
                ...
                onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleDataChange('timeout', parseInt(e.target.value) || 30000)}
                min="1000"
                step="1000"
                className="w-full px-2 py-1 text-sm border border-gray-300 rounded"
              />
